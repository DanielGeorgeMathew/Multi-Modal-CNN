...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        # paths
        self.add_argument('--nb_classes', default=4, type=int,
        ...
        self.add_argument('--freeze', default=0, type=int,
                          help='number of epochs the whole model (except for '
                               'the output layer(s) are freezed.')
        ...
        self.add_argument('--weight_decay', '--wd', default=1e-3, type=float,
                          help='weight decay')
        ...
        self.add_argument('--valid_full_res', default=False,
                          ...
                          help='Whether to validate on the full resolution '
                               '(for cityscapes).')
        self.add_argument('--save_ckpt_freq', default=1, type=int)
        self.add_argument('--save_ckpt_num', default=3, type=int)
        # model
        ...
        self.add_argument('--min_lr', type=float, default=1e-6, metavar='LR',
                        help='lower lr bound for cyclic schedulers that hit 0 (1e-6)')
        self.add_argument('--warmup_epochs', type=int, default=20, metavar='N',
